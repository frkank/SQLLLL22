...
VALUES
	('Kalite'),('Yönetim'),('Arge'),('Teknik')

	--tblDepartman Tablosuun departman ad alanýnýn UNIQUE olmasý gerekiyor.
	--Fakat balangýçta bunu düþünemedik, þimdi yapýyoruz.
...
VALUES
	('Muhendis'),('ÝK Uzmaný'),('Teknisyen')

--Ýller tablosu oluturuyor.
...
VALUES
	...
	('Demet','ÇOLAK','K','1982.05.05',5,'2005.06.17',4,3,2800),
	('Evrim','ÇITAK','K','1987.12.05',1,'2000.01.12',1,2,4500),
	...
	('Ilgýn','ACI','E','1974.05.01',2,'2000.08.18',4,1,4200),
	('Ýskender','TAÞ','E','1974.07.02',7,'1995.09.05',2,2,4400),
	('Jale','CAN','K','1976.09.18',5,'1998.10.12',1,1,3250),
	('Kamil','ALBAYRAK','E','1976.08.19',9,'2000.11.25',3,1,5200),
	('Leman','HASKIRIÞ','K','1978.09.20',6,'1999.10.27',3,1,4200),
	...
	('Ömer','BUZDAÐ','E','1980.10.30',5,'2001.08.10',3,1,4800),
	('Perihan','KANAT','K','1980.10.28',4,'2001.07.11',2,2,2200),
	('Ramiz','ÇAKIR','E','1981.11.19',7,'2001.07.30',2,3,2700),
	('Sertaç','KÖSEDAÐ','E','1981.12.20',9,'2002.12.20',4,1,2900),
	('Þefik','ÇAPANOÐLU','E','1982.02.20',6,'1998.05.25',4,3,4800),
	('Taner','BOZOKLU','E','1983.07.21',5,'2005.09.05',3,1,3000),
	('Utku','DUMAN','E','1975.06.13',6,'2005.03.05',3,3,2800),
	('Ümit','ÞÝRÝN','E','1978.04.02',7,'1998.04.04',1,1,3300),
	('Veysel','ERTÜZÜN','E','1980.07.03',3,'2002.07.18',2,3,3100),
	('Yakup','GÖKÇE','E','1975.06.18',2,'2002.03.25',2,3,3100),
	('Zeliha','CANÝÞ','K','1978.03.03',5,'2005.08.13',3,3,2500)

--Görevlendirmeler Tablosu olþt.
...
--görevlendirme tablosu veri giriþi
